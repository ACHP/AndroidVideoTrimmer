...
//The same for resource
inline fun Resources.dip(value: Int): Int = (value * displayMetrics.density).toInt()
inline fun Resources.dip(value: Float): Int = (value * displayMetrics.density).toInt()
inline fun Resources.sp(value: Int): Int = (value * displayMetrics.scaledDensity).toInt()
inline fun Resources.sp(value: Float): Int = (value * displayMetrics.scaledDensity).toInt()
inline fun Resources.px2dip(px: Int): Float =  px.toFloat() / displayMetrics.density
inline fun Resources.px2sp(px: Int): Float = px.toFloat() / displayMetrics.scaledDensity
inline fun Resources.dimen(@DimenRes resource: Int): Int = getDimensionPixelSize(resource)